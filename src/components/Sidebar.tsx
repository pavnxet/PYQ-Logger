...
import { ChevronRight, ChevronDown, BookOpen, Search, Settings, Brain } from 'lucide-react';
    ...
    <aside className="w-64 bg-gray-900 text-white h-screen flex flex-col fixed left-0 top-0 overflow-y-auto">
      ...
      <div className="p-4">
        ...
        <nav className="space-y-1">
          <Link
            href="/quiz"
            className="flex items-center gap-2 p-2 rounded-md hover:bg-gray-800 transition-colors text-white mb-4 bg-gray-800/50"
          >
